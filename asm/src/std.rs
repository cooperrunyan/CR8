...
pub static STD: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "core" => include_str!("core/mod.asm"),
    "core::arch" => include_str!("core/arch.asm"),
    "core::macro" => include_str!("core/macro/mod.asm"),
    "core::macro::util" => include_str!("core/macro/util.asm"),
    "core::macro::math" => include_str!("core/macro/math/mod.asm"),
    "core::macro::math::add" => include_str!("core/macro/math/add.asm"),
    "core::macro::math::sub" => include_str!("core/macro/math/sub.asm"),
    "core::macro::call" => include_str!("core/macro/call.asm"),
    "core::macro::clear" => include_str!("core/macro/clear.asm"),
    "core::macro::jmp" => include_str!("core/macro/jmp.asm"),
    "core::macro::logic" => include_str!("core/macro/logic.asm"),
    "core::macro::send" => include_str!("core/macro/send.asm"),
