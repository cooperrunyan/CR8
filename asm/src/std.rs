...
pub static STD: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "std::gfx::grid" => include_str!("std/gfx/grid/mod.asm"),
    "std::gfx::grid::point" => include_str!("std/gfx/grid/point.asm"),
    "std::gfx::grid::inline_box" => include_str!("std/gfx/grid/inline_box.asm"),
    "std::gfx::grid::cfg" => include_str!("std/gfx/grid/cfg.asm"),
    "std::gfx::grid::box" => include_str!("std/gfx/grid/box/mod.asm"),
    "std::gfx::grid::box::bordered" => include_str!("std/gfx/grid/box/bordered.asm"),
    "std::gfx::grid::box::clear" => include_str!("std/gfx/grid/box/clear.asm"),
    "std::gfx::grid::box::custom" => include_str!("std/gfx/grid/box/custom.asm"),
    "std::gfx::grid::box::filled" => include_str!("std/gfx/grid/box/filled.asm"),
