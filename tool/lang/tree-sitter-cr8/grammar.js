module.exports = grammar({
  ...
  rules: {
    ...
    meta: $ =>
      seq(
        $.meta_open,
        choice($.main, $.const, $.dyn, $.macro, $.static, $.use),
      ),
    instruction: $ =>
      seq(
        $.word,
    ...
    macro_capture_arg: $ =>
      seq($.macro_variable, $.colon, $.macro_variable_type),

    macro_variable_type: $ =>
      choice(token('reg'), token('lit'), token('expr'), token('any')),
    ...
    expr_term: $ =>
      prec.left(
        ...
        choice(
          ...
          $.label,
          $.expr,
          prec.left(10, seq($.paren_open, $.expr, $.paren_close)),
        ),
      ),
  },
});
